...
const int avancerPin = 5; // Broche utilisée pour envoyer la commande "avancer"
const int gauchePin = 6; // Broche utilisée pour envoyer la commande "tourner à gauche"
const int droitePin = 7; // Broche utilisée pour envoyer la commande "tourner à droite"
const int reculerPin = 8; // Broche utilisée pour envoyer la commande "reculer"

const int led1Pin = 9; // Broche de la LED 1
const int led2Pin = 10; // Broche de la LED 2
const int led3Pin = 11; // Broche de la LED 3
const int led4Pin = 12; // Broche de la LED 4
